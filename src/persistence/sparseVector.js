 ...
 */
export function buildVector(chunk, idf) {
    const dims = new Map();
    // ── Text token TF-IDF ──
 ...
 */
export function buildVectors(chunks) {
 ...
 */
export function buildVectorsWithIdf(chunks, idf) {
 ...
 */
export function buildQueryVector(queryText, fileHints, idf) {
    const dims = new Map();
